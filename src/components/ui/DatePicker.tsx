...
export function DatePicker({ value, onChange, placeholder = 'Select Date', minDate, className = '' }: DatePickerProps) {
            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className="absolute top-[calc(100%+8px)] left-0 z-50 p-4 bg-[#1a1a24] border border-white/10 rounded-2xl shadow-2xl w-[280px]"
                    >
                        {/* Header */}
